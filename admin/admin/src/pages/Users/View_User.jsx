    ...
    <div className="w-full">
          <div>
            ...
            <div className="flex justify-between border mx-[20px] px-[20px] items-center mt-[40px] bg-blue-50 py-[10px] rounded-t-[10px]">
              <h3 className="font-medium text-[25px]">View User</h3>
            ...
            <table className="mx-[20px] bg-blue-950 py-[40px] text-white w-[96%] text-left border-collapse">
              ...
              <thead className="font-bold">
                <tr>
                  ...
                  <th className="border border-white text-[15px]">EMAIL ID</th>
              ...
              <tbody>
                <tr>
                  ...
                  <td className="border border-white"><button className="bg-green-500 px-3 py-1 rounded-md font-medium">
                      Active
                    </button></td>
                ...
                <tr>
                  ...
                  <td className="border border-white"><button className="bg-red-500 px-3 py-1 rounded-md font-medium">
                      Deactive
                    </button></td>
                  <td className="border border-white">
                    <div className="mx-[30px] py-[8px] bg-blue-800 rounded-[50%] flex items-center justify-center">
